...
public class CadenaDeCustodiaDelegateImpl implements CadenaDeCustodiaDelegate {
     ...
     */
    @Override
    public List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXExpediente(ExpedienteDTO expedienteDto) throws NSJPNegocioException {
        return consultarCadenaCustodiaXExpedienteService.consultarCadenaCustodiaXExpediente(expedienteDto);
    }
    
    @Override
    public List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXIdExpediente(Long expedienteId) throws NSJPNegocioException {
        return consultarCadenaCustodiaXExpedienteService.consultarCadenaCustodiaXIdExpediente(expedienteId);
    }
	...
	@Override
	public List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXNumeroExpediente(
			Long expedienteId, String folioCadena)throws NSJPNegocioException {
		return consultarCadenaCustodiaXExpedienteService.consultarCadenaCustodiaXExpedienteYFolio(expedienteId,folioCadena);		
	}
