...
public interface CadenaDeCustodiaDelegate {
     ...
     * buscar.
     */
    List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXExpediente(ExpedienteDTO expedienteDto) throws NSJPNegocioException;
    
    List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXIdExpediente(Long expedienteId) throws NSJPNegocioException;
    /**
     ...
     * @throws NSJPNegocioException
     */
    public List<CadenaDeCustodiaDTO> consultarCadenaCustodiaXNumeroExpediente (Long expedienteId, String folioCadena)throws NSJPNegocioException;
