...
//	}
	...
	// eNABLE IT: Se agrega método para consulta de solicitudes de audiencia por
		// id
		@Override
		public SolicitudAudienciaDTO consultarSolicitudAudienciaById(
				Long idAudiencia) throws NSJPNegocioException {
			return this.consultarSolicutdes
					.consultarSolicitudAudienciaById(idAudiencia);
		}
	
		//eNABLE IT: Metodo para consultar audiencias por medio de fecha y usuario
	@Override
	public List<AudienciaDTO> consultarAudienciasByFechasyFuncionario(
				Long claveFuncionario, AudienciaDTO audiencia)
				throws NSJPNegocioException {
		return this.cosultaAudienciasService
				.consultarAudienciasByFechasyFuncionario(audiencia,
						claveFuncionario);
		}
}
