...
public interface AvisoDetencionDelegate {
	 ...
	 *
	 * @param idInvolucrado
	 * @return true si se ha solicitado defensor anteriormente, false en caso contrario.
	 */
	Boolean tieneInvAvisosDetencion(Long idInvolucrado);

	/**
	 *
	 * @param idInvolucrado
	 * @return true si el Involucrado tiene una Denuncua Generada
	 */
	Boolean tieneDenunciaGenerada(Long idInvolucrado)throws NSJPNegocioException;
	 ...
	 * @return true si el Involucrado tiene una Denuncua Generada
	 */
	Boolean tieneAvisoDetencion(Long idInvolucrado)throws NSJPNegocioException;
    ...
    /**
     * Registra en BD el aviso de designacion  y lo envía por WS a defensoria.
     *
     * @param input
     *            <ul>
     *            <li>involucradoDTO.elementoId</li>
     ...
     * @throws NSJPNegocioException
     */
    void enviarAvisoSinDetencion(SolicitudDefensorDTO solicitud,Long idAgencia, String claveAgencia,Long idFuncionarioSolicitante) throws NSJPNegocioException;
    
    /**
	 * Obtiene el detalle de un aviso de detencion de acuero al expedienteid
	 * @throws NSJPNegocioException
	 */
	AvisoDetencionDTO obtenerAvisoDetencionCoordinadorDef(Long expedienteId) throws NSJPNegocioException;
