 ...
 * Marca de cambio        : N/A                                                     
 * Descripcion General    : Implementación del delegate para los servicios de expediente                       
...
public class ExpedienteDelegateImpl implements ExpedienteDelegate {
	...
	@Override
	public boolean asociarNumCarpetaASolicitud(ExpedienteDTO expedienteDTO, String numExpedientePadre_id,
			Long idSolicitud) throws NSJPNegocioException {
		return administrarNumeroExpediente.asociarNumCarpetaASolicitud(
				expedienteDTO, numExpedientePadre_id, idSolicitud);
	}
	...
	public void asignarPermisoExpedienteFuncionario(Long claveFuncionario, Long numExpId,Date fechaLimite, Boolean permiso) throws NSJPNegocioException {
		registrarPermisoExpedienteService.registrarPermisoExpedienteFuncionario(claveFuncionario, numExpId, fechaLimite, permiso);
	}

	@Override
	public void eliminarPermisoExpedienteFuncionario(Long claveFuncionario,
			Long numExpId) throws NSJPNegocioException {
		registrarPermisoExpedienteService.eliminarPermisoExpedienteFuncionario(claveFuncionario, numExpId);
	}
	...
	public List<ExpedienteDTO> buscarRemisionesConIPH(EstatusExpediente estatusExpediente,Long CatUIED)throws NSJPNegocioException{
		return service.buscarRemisionesConIPH(estatusExpediente,CatUIED);
	}
	...
	public Boolean reasignarFuncionarioDeNumeroExpediente(List<ExpedienteDTO> lstExpedienteDTO, HistoricoExpedienteDTO historicoExpedienteDTO)
			throws NSJPNegocioException{
		return actualizarExpedienteService.reasignarFuncionarioDeNumeroExpediente(lstExpedienteDTO, historicoExpedienteDTO);
	}
	...
	public List<ExpedienteDTO> consultarExpedientesJusticiaRestaurativaPorArea (Long areaId, Long claveFuncionario) throws NSJPNegocioException {
		return service.consultarExpedientesJusticiaRestaurativaPorArea(areaId,  claveFuncionario); 
	}
	...
	/*Enable IT GB*/
	@Override
	public List<ExpedienteDTO> consultarExpedientesPorCasoEna(CasoDTO caso)
			throws NSJPNegocioException {
		// TODO Auto-generated method stub
		return service.consultarExpedientescPorCasoEna(caso);
	}

	@Override
	public ExpedienteDTO relacion(ExpedienteDTO expediente)
			throws NSJPNegocioException {
		return actualizarExpedienteService.crearRelacion(expediente);
	}

	@Override
	public List<ExpedienteDTO> consultarExpedientesCompartidosDefensor(
			Long iClaveFuncionario) throws NSJPNegocioException {		
		return service.consultarExpedientesCompartidosDefensor(iClaveFuncionario);
	}
