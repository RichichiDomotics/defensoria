...
public interface AudienciaDAO extends GenericDao<Audiencia, Long> {
    ...
    List<Audiencia> buscarAudiencias(Long usrId, Long expNumeroId, Date fecIni,
            Date fecFin, boolean diaCompleto, Long tipoAudiencia, boolean isCausa,Long discriminanteId, Long idDistrito, List<Long> estatusAudiencia,String rol,Long estatusSolicitud);
    /**
     * 
     * @param solId
     * @return
	...
	/**
	 * Metodo que permite consultar las audiencias por funcionario y fechas
	 * @param claveFuncionario
	 * @param fecIni
	 * @param fecFin
	 * @return List<Audiencia>
	 */
	public List<Audiencia> consultarAudienciasPorUsuario(Long claveFuncionario, Date fecIni, Date fecFin);
}