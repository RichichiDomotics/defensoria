...
//    }
    ...
    @SuppressWarnings("unchecked")
	public List<CadenaDeCustodia> consultarCadenaCustodiaXIdExpediente(Long expedienteId) {        
	    StringBuffer queryStr = new StringBuffer();
	    queryStr.append(" FROM CadenaDeCustodia c WHERE c.expediente.expedienteId =")
                .append(expedienteId);
        Query query = super.getSession().createQuery(queryStr.toString());
        return query.list();
	}
