...
//        Valor valor = new Valor();
   ...
   public void testConsultarConfActividadDocumento(){
	...
	List<ConfActividadDocumento> listaConfActividadDocumento = daoServcice.consultarConfActividadDocumento(jerarquiaOrganizacionalId, numeroExpediente, idCategoriaActidad, null);
