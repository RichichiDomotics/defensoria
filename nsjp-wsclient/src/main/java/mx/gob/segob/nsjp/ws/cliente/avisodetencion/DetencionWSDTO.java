 ...
 *         &lt;element name="edadDetenido" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/>
 *         &lt;element name="sexoDetenido" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class DetencionWSDTO extends GenericWSDTO{
    ...
    protected Long edadDetenido;
    protected String sexoDetenido;
	...
	public Long getEdadDetenido() {
		return edadDetenido;
	}

	public void setEdadDetenido(Long edadDetenido) {
		this.edadDetenido = edadDetenido;
	}

	public String getSexoDetenido() {
		return sexoDetenido;
	}

	public void setSexoDetenido(String sexoDetenido) {
		this.sexoDetenido = sexoDetenido;
	}
