...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.DocumentoOficialWSDTO;
...
public class DocumentoOficialTransformer {
	...
	public static DocumentoOficialWSDTO transformarDocumentoOficialDTO(DocumentoOficialDTO src){
		DocumentoOficialWSDTO dest = null;
		
		if(src != null){
			dest = new DocumentoOficialWSDTO();
			if(src.getTipoDocumento() != null){
				dest.setTipoDocumento(src.getTipoDocumento().getIdCampo());
			}
