...
public class CadenaDeCustodiaTransformer {
     ...
     */
    public static CadenaDeCustodiaDTO transformarCadenaDeCustodia(CadenaDeCustodia cadenaDeCustodia) {
        ...
        if (cadenaDeCustodia.getEvidencias() != null) {
            ...
            for (Evidencia evidencia : cadenaDeCustodia.getEvidencias()) {
                ...
                cadenasimple.setCadenaDeCustodiaId(cadenaDeCustodia.getCadenaDeCustodiaId());
        ...
        if (cadenaDeCustodia.getExpediente() != null){
            cadenaDeCustodiaDTO.setExpedienteDTO(ExpedienteTransformer.transformarExpedienteBasico(cadenaDeCustodia.getExpediente()));
        }
