...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.VegetalWSDTO;
...
public class VegetalTransformer {
	...
	public static VegetalWSDTO transformarVegetalDTO(VegetalDTO src){
		VegetalWSDTO dest = null;
		if(src != null){
			dest = new VegetalWSDTO();
			if(src.getTipoVegetal() != null){
				dest.setTipoVegetal(src.getTipoVegetal().getIdCampo());
			}
			if(src.getUnidadMedida() != null){
