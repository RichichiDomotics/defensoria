...
public class AvisoDetencionTransformer {
	...
	public static AvisoDetencionDTO transformarAvisoDetencion(AvisoDetencion aviso) {
		...
		if (aviso.getDetencion() != null) {
			dto.setFechaDetencion(aviso.getDetencion().getFechaInicioDetencion());
		}
		...
		dto.setConfInstitucion(new ConfInstitucionDTO(aviso.getConfInstitucion().getConfInstitucionId(), aviso.getConfInstitucion().getNombreInst()));
		...
		dto.setExpedienteDTO(ExpedienteTransformer.transformaExpediente(aviso.getExpediente()));
		// Fin todo

		if (aviso.getDetencion() != null) {
			dto.setDetencion(DetencionTransformer.transformarDetencion(aviso.getDetencion()));
		}
	...
	public static AvisoDetencion transformarAvisoDetencion(AvisoDetencionDTO aviso) {
