...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.EmbarcacionWSDTO;
...
public class EmbarcacionTransformer {
	...
	public static EmbarcacionWSDTO transformarEmbarcacionDTO(EmbarcacionDTO src){
		EmbarcacionWSDTO dest = null;
		
		if(src != null){
			dest = new EmbarcacionWSDTO();
			if(src.getMarca() != null){
				dest.setMarca(src.getMarca().getIdCampo());
			}
			if(src.getTipoEmbarcacion() != null){
				dest.setTipoEmbarcacion(src.getTipoEmbarcacion().getIdCampo());
			}
			if(src.getPaisOrigen() != null){
				dest.setPaisOrigen(src.getPaisOrigen().getIdCampo());
			}
			if(src.getSubMarca() != null){
				dest.setSubMarca(src.getSubMarca().getIdCampo());
			}
			if(src.getColor() != null){
				dest.setColor(src.getColor().getIdCampo());
			}
