...
//		logger.info("Estatus: "+numeroExpediente.getEstatus());
	...
	@Transactional
	public ExpedienteDTO insertaEstatusExpediente(ExpedienteDTO expedienteDTO)
			throws NSJPNegocioException {
		System.out.println("Servicio actualizarEstatusExpediente");
		ExpedienteDAO expDAO = this.expedienteDAO;
		Expediente expedienteNvo = new Expediente();
		if( expedienteDTO == null || expedienteDTO.getNumeroExpedienteId()==null ||
				expedienteDTO.getEstatus()== null )
				expedienteNvo.setExpedienteId(1L);
		expDAO.create(expedienteNvo);
		return expedienteDTO;
	}
