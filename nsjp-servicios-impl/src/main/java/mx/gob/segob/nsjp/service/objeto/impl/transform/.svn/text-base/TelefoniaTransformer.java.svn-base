...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.TelefoniaWSDTO;
...
public class TelefoniaTransformer {
	...
	public static TelefoniaWSDTO transformarTelefoniaDTO(TelefoniaDTO src){
		TelefoniaWSDTO dest = null;
		if(src != null){
			dest = new TelefoniaWSDTO();
			if(src.getTipoTelefono() != null){
				dest.setTipoTelefono(src.getTipoTelefono().getIdCampo());
			}
			if(src.getMarca() != null){
