...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.AeronaveWSDTO;
...
public class AeronaveTransformer {
	...
	public static AeronaveWSDTO transformarAeronaveDTO(AeronaveDTO src){
		AeronaveWSDTO destino = null;
		if(src != null){
			destino = new AeronaveWSDTO();
			if(src.getMarca() != null){
				destino.setMarca(src.getMarca().getIdCampo());
			}
			
			if(src.getTipoAeroNave() != null){
				destino.setTipoAeroNave(src.getTipoAeroNave().getIdCampo());
			}
			
			if(src.getPaisProcedencia() != null){
				destino.setPaisProcedencia(src.getPaisProcedencia().getIdCampo());
			}
			
			if(src.getSubMarca() != null){
				destino.setSubMarca(src.getSubMarca().getIdCampo());
			}
			
			if(src.getColor() != null){
				destino.setColor(src.getColor().getIdCampo());
			}
			destino.setModelo(src.getModelo());
			destino.setMatricula(src.getMatricula());
			destino.setNoSerie(src.getNoSerie());
