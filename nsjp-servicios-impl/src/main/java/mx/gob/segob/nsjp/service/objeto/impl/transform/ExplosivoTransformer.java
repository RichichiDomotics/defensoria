...
import mx.gob.segob.nsjp.ws.cliente.avisodetencion.ExplosivoWSDTO;
...
public class ExplosivoTransformer {
	...
	public static ExplosivoWSDTO transformarExplosivoDTO(ExplosivoDTO src){
		ExplosivoWSDTO dest = null;
		if(src != null){
			dest = new ExplosivoWSDTO();
			if(src.getTipoExplosivo() != null){
				dest.setTipoExplosivo(src.getTipoExplosivo().getIdCampo());
			}
			if(src.getUnidadMedida() != null){
