...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/timer/jquery.idletimer.js"></script>
	...
	*/
	...
	/*
	*Funcion que carga el grid de documentos atendidos
	*/
	function cargaGridDocumentosAtendidos(){
		if(firstGridDocumentosRecibidos == true){
			
			jQuery("#gridDocumentosRecibidos").jqGrid({ 
				url:'<%= request.getContextPath()%>/solicitudesEvidenciaConcluidasPerito.do?estatus=3&areaSolicitante=2', 
				datatype: "xml", 
				colNames:['Número de Expediente','Tipo de Documento','Nombre del Documento','Fecha de Cierre','Documento Enviado' ], 
				colModel:[ 	{name:'NumeroExpediente',index:'1', width:200},
				           	{name:'TipoDocumento',index:'2', width:200},
				           	{name:'NombreDocumento',index:'3', width:200},
				           	{name:'FechaCierre',index:'4', width:200}, 
							{name:'DocumentoEnviado',index:'5', width:200}
						],
				pager: jQuery('#pagerDocumentosRecibidos'),
				rowNum:10,
				rowList:[10,20,30],
				autowidth: true,
				autoheight:true,
			...
			}).navGrid('#pagerGridDocumentosRecibidos',{edit:false,add:false,del:false});

			//cambia la variable a falso para ya no dibujar el grid, solo recargarlo
			firstGridEvidenciasConcluidas=false;
		}
		else{
			jQuery("#gridDocumentosRecibidos").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/solicitudesEvidenciaConcluidasPerito.do?estatus=3&areaSolicitante=2',datatype: "xml" });
			$("#gridDocumentosRecibidos").trigger("reloadGrid");			
		}
		
		//muestra este grid y oculta los demas
		ocultaMuestraGrids('gridDocumentosRecibidos');
	}
...
/////////////////////////////////////////////////////////////////////////FUNCIONALIDAD PARA ASIGNACIONES RECIBIDAS ////////////////////////////////////////////////////////////////
   ...
   */
   function cargaGridAsignacionesRecibidasEnProceso(){
	   ...
	   if(firstGridAsignacionesRecibidasEnProceso== true){
		   ...
		   jQuery("#gridAsignacionesRecibidasEnProceso").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Número Expediente','Número de Caso','Fecha de Solicitud','Fecha Última Modificación','Documento creado'], 
   ...
   function elaborarDocumento(tipo){
	   	   
	   
		$.newWindow({id:"iframewindowElaborarDocumento", statusBar: true, posx:200,posy:50,width:1050,height:600,title:(tipo=='Dictamen'?"Dictámenes":"Informes")+" Elaborados", type:"iframe"});
	    $.updateWindowContent("iframewindowElaborarDocumento",'<iframe src="<%= request.getContextPath() %>/elaborarDocumentoPerito.do?tipo='+tipo+'" width="1050" height="600" />');		
...
<!--<h3><a id="bPeritoEvidencia" href="#">Solicitudes de Evidencia</a></h3>-->
<!--<div>-->
<!--	<ul>-->
<!--	   <li><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="evidenciaNueva" onclick="cargaGridEvidenciasNuevas();">Nuevas</a></span></li>-->
<!--	   <li><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="evidenciaPendiente" onclick="cargaGridEvidenciasPendientes();">Pendientes</a></span></li>-->
<!--	   <li><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="evidenciaConcluida" onclick="cargaGridEvidenciasConcluidas();">Concluidas</a></span></li>-->
<!--	</ul>-->
<!--</div>-->
<!--<h3><a id="bPeritoSeguimiento" href="#">Seguimiento de Investigación</a></h3>-->
<!--<div>-->
<!--	<ul id="seccion2tree" class="filetree">	-->
<!--	   <li><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="dictamen" onclick="elaborarDocumento('Dictamen');">Dictamen</a></span></li>-->
<!--	   <li><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="informe" onclick="elaborarDocumento('Informe');">Informe</a></span></li>-->
<!--	</ul>-->
<!--</div>-->
<!--<h3><a id="bPeritodocumentos" href="#">Concluir Investigaci&oacute;n</a></h3>-->
<!--<div>-->
<!--	<table width="100%" border="0" bordercolor="#FFFFFF" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" style="cursor:pointer">-->
<!--		<tr>-->
<!--		   <td><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="documentosRecibidos" onclick="cargaGridDocumentosAtendidos();">Documentos Atendidos</a></span></td>-->
<!--		</tr>-->
<!--	</table>-->
<!--</div>-->
<!--<h3><a id="bPeritodocumentos" href="#">Devoluci&oacute;n de Evidencia</a></h3>-->
<!--<div>-->
<!--	<table width="100%" border="0" bordercolor="#FFFFFF" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" style="cursor:pointer">-->
<!--		<tr>-->
<!--		   <td><span><img src="<%=request.getContextPath()%>/resources/css/check.png" width="16" height="16"  /><a id="resguardoEvidencia" onclick="cargaGridResguardoEvidencia();">Resguardo de Evidencias</a></span></td>-->
<!--		</tr>-->
<!--	</table>-->
<!--</div>-->
</div>
