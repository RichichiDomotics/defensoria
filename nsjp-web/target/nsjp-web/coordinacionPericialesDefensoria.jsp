...
<head>
	...
	*/
	...
	function designarPerito(solicitudPericialId, area){
		idWindowDesignarPerito++;
		$.newWindow({id:"iframewindowConsultarDenunciante" + idWindowDesignarPerito, statusBar: true, posx:50,posy:50,width:1350,height:400,title:"Designar Perito", type:"iframe"});
		$.updateWindowContent("iframewindowConsultarDenunciante" + idWindowDesignarPerito,'<iframe src="<%= request.getContextPath() %>/designarPerito.do?solicitudPericialId=' +solicitudPericialId +'&area='+area+'" width="1350" height="400" />');
	}
	...
	*/
	function ocultaMuestraGrids(nombreGrid){
		...
		if(nombreGrid == "gridSolicitudesDeDictamenNoAtendidas"){

			//Este grid ya se encontraba CHECARLO
			$("#divGridSolicitudes").hide();
			//Este grid ya se encontraba
		...
		if(nombreGrid == "gridSolicitudesDeDictamenEnProceso"){
		...
		if(nombreGrid == "gridSolicitudesDeDictamenTerminadas"){
		...
		if(nombreGrid == "gridSolicitudesDeAsesoriaEnProceso"){
		...
		if(nombreGrid == "gridSolicitudesDeAsesoriaTerminadas"){
		...
		if(nombreGrid == "gridSolicitudesDeAsesoriaNoAtendidas"){
		...
		if(nombreGrid == "gridAdmonPlantillaConsulta"){
			...
			jQuery("#gridSolicitudesDeDictamenNoAtendidas").jqGrid({ 
				...
				colModel:[ 	{name:'NumeroFolio',index:'1', width:127},
							...
							{name:'NumeroExpediente',index:'3', width:127},
				           	{name:'NombreSolicitante',index:'4', width:127},
				           	{name:'EspecialidadPerito',index:'5', width:127}, 
							{name:'FechaLimite',index:'6', width:127}
						],
				...
				ondblClickRow: function(rowid) {
					/*mandando variales/*ByYolo*/
 					var ret2 = jQuery("#gridSolicitudesDeDictamenNoAtendidas").jqGrid('getRowData',rowid);
 					var numidExpedienteDoc=ret2.NumeroExpediente;
 					designarPeritoTest("false","false",numidExpedienteDoc,rowid,"NA",1);
 					/*fin/*ByYolo*/
// 					designarPerito(rowid,2);
				}
			...
			jQuery("#gridSolicitudesDeDictamenNoAtendidas").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesNoAtendidasCoordinadorPerDef.do?tipoSolicitud=<%=TiposSolicitudes.DICTAMEN.getValorId()%>&area=2',datatype: "xml" });
			...
			jQuery("#gridSolicitudesDeDictamenEnProceso").jqGrid({ 
				...
				colModel:[ 	{name:'NumeroFolio',index:'1', width:109},
							{name:'NumeroCaso',index:'2', width:109},
				           	...
				           	{name:'NombreSolicitante',index:'4', width:109},
				           	{name:'EspecialidadPerito',index:'5', width:109}, 
							{name:'FechaLimite',index:'6', width:109},
							{name:'FechaUltModif',index:'7', width:109,hidden:true}
						],
				...
				ondblClickRow: function(rowid) {
					/*mandando variales/*ByYolo*/
 					var ret2 = jQuery("#gridSolicitudesDeDictamenEnProceso").jqGrid('getRowData',rowid);
 					var numidExpedienteDoc=ret2.NumeroExpediente;
 					designarPeritoTest("false","false",numidExpedienteDoc,rowid,"NA",1);
 					/*fin/*ByYolo*/
// 					designarPerito(rowid,2);
			...
			jQuery("#gridSolicitudesDeDictamenEnProceso").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesEnProcesoCoordinadorPerDef.do?tipoSolicitud=<%=TiposSolicitudes.DICTAMEN.getValorId()%>',datatype: "xml" });
	...
	function cargaGridSolicitudesDeDictamenTerminadas(){
		...
		if(firstGridSolicitudesDeDictamenTerminadas == true){
			...
			jQuery("#gridSolicitudesDeDictamenTerminadas").jqGrid({ 
				...
				ondblClickRow: function(rowid) {
					/*mandando variales/*ByYolo*/
 					var ret2 = jQuery("#gridSolicitudesDeDictamenTerminadas").jqGrid('getRowData',rowid);
 					var numidExpedienteDoc=ret2.NumeroExpediente;
 					designarPeritoTest("true","true",numidExpedienteDoc,rowid,"NA",1);
 					/*fin/*ByYolo*/
// 					designarPerito(rowid,"NA",1);
			...
			jQuery("#gridSolicitudesDeDictamenTerminadas").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesTerminadasCoordinadorPerDef.do?tipoSolicitud=<%=TiposSolicitudes.DICTAMEN.getValorId()%>&area=2',datatype: "xml" });
	...
	function cargaGridSolicitudesDeAsesoriaNoAtendidas(){
		...
		if(firstGridSolicitudesDeAsesoriaNoAtendidas == true){
			...
			jQuery("#gridSolicitudesDeAsesoriaNoAtendidas").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Número de Folio','Número de Caso','Número de Expediente','Nombre del Solicitante','Especialidad del Asesor','Fecha de Solicitud' ], 
				colModel:[ 	{name:'NumeroFolio',index:'1', width:125},
				           	{name:'NumeroCaso',index:'2', width:125},
				           	{name:'NumeroExpediente',index:'3', width:125},
							{name:'NombreSolicitante',index:'4', width:125},
				           	{name:'EspecialidadPerito',index:'5', width:125}, 
							{name:'FechaLimite',index:'6', width:125}
						],
			...
			jQuery("#gridSolicitudesDeasesoriaNoAtendidas").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesNoAtendidas.do?estatus=1',datatype: "xml" });
	...
	function cargaGridSolicitudesDeAsesoriaProceso(){
		...
		if(firstGridSolicitudesDeAsesoriaEnProceso == true){
			...
			jQuery("#gridSolicitudesDeAsesoriaEnProceso").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Número de folio','Número de caso','Número de expediente','Nombre del solicitante','Especialidad del asesor','Fecha de Solicitud','Fecha ultima de modificación' ], 
				colModel:[ 	{name:'NumeroFolio',index:'1', width:109},				           	
				           	{name:'NumeroCaso',index:'2', width:109},
				           	{name:'NumeroExpediente',index:'3', width:109},
				           	{name:'NombreSolicitante',index:'4', width:109},
				           	{name:'EspecialidadPerito',index:'5', width:109}, 
							{name:'FechaLimite',index:'6', width:109},
							{name:'FechaModificacion',index:'7', width:109,hidden:true}
						],
			...
			jQuery("#gridSolicitudesDeAsesoriaEnProceso").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesEnProceso.do?estatus=2',datatype: "xml" });
	...
	function cargaGridSolicitudesDeAsesoriaTerminadas(){
		...
		if(firstGridSolicitudesDeAsesoriaTerminadas == true){
			...
			jQuery("#gridSolicitudesDeAsesoriaTerminadas").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Número de Folio','Número de Caso','Número de Expediente','Nombre del Solicitante','Perito Designado','Especialidad','Fecha de Solicitud','Fecha Cierre' ], 
				colModel:[ 	{name:'NumeroFolio',index:'1', width:95},
				           	{name:'NumeroCaso',index:'2', width:95},
				           	{name:'NumeroExpediente',index:'3', width:95},
				           	{name:'NombreSolicitante',index:'4', width:95},			           	
				           	{name:'PeritoDesignado',index:'5', width:95}, 
				           	{name:'EspecialidadPerito',index:'6', width:95}, 
							{name:'FechaLimite',index:'7', width:95},
							{name:'FechaCierre',index:'8', width:95}
						],
			...
			jQuery("#gridSolicitudesDeAsesoriaTerminadas").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarSolicitudesPericialesTerminadas.do?estatus=3',datatype: "xml" });
	...
	*/
	function cargaTipoDocumentos() {
  	...
  	//Abre una nueva ventana para designar un perito/*ByYolo*/ 		
	function designarPeritoTest(deshabilitarPestanas,deshabilitarBotonSP,numidExpedienteDoc,solicitudPericialId, estatus, area){
		idWindowDesignarPerito++;
		$.newWindow({id:"iframewindowConsultarDenunciante" + idWindowDesignarPerito, statusBar: true, posx:50,posy:50,width:1150,height:550,title:"Designar Perito", type:"iframe"});
		$.updateWindowContent("iframewindowConsultarDenunciante" + idWindowDesignarPerito,'<iframe src="<%= request.getContextPath() %>/designarPerito.do?solicitudPericialId=' +solicitudPericialId +'&estatus='+estatus+'&numidExpedienteDoc='+numidExpedienteDoc+'&area='+area+'&deshabilitarBotonSP='+deshabilitarBotonSP+'&deshabilitarPestanas='+deshabilitarPestanas+'" width="1350" height="550" />');
	}
...
function visorLeyesCodigos() {
		...
		$.newWindow({id:"iframewindowRestaurativa", statusBar: true, posx:253,posy:111,width:813,height:440,title:"Leyes y C&oacute;digos", type:"iframe"});
	    $.updateWindowContent("iframewindowRestaurativa",'<iframe src="<%= request.getContextPath() %>/detalleLeyesyCodigos.do" width="813" height="440" />');
	...
	*/
	function generaVisorGraficaView() {
		$.newWindow({id:"iframewindowWindowImageViewer", statusBar: true, posx:53,posy:111,width:1140,height:400,title:"Visor de imagenes", type:"iframe"});
...
<div class="ui-layout-west">	
	...
	<div class="content">
		...
		<div id="accordionmenuprincipal">
				...
				<div>
					<ul id="seccion1tree" class="filetree">
						<li class="closed" ><span class="folder">Periciales</span>
							<ul>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="pericialesNoAtendida" onclick="cargaGridSolicitudesDeDictamenNoAtendidas();">Nuevas</a></span></li>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="pericialesEnProceso" onclick="cargaGridSolicitudesDeDictamenProceso();">Pendientes</a></span></li>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="pericialesTerminada" onclick="cargaGridSolicitudesDeDictamenTerminadas();">Concluidas</a></span></li>
							</ul>			
						</li>
						<li class="closed" ><span class="folder">Asesorias</span>
							<ul>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="asesoriasNoAtendida" onclick="cargaGridSolicitudesDeAsesoriaNoAtendidas();">Nuevas</a></span></li>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="asesoriasEnProceso" onclick="cargaGridSolicitudesDeAsesoriaProceso();">Pendientes</a></span></li>
							   <li><span><img src="<%=request.getContextPath()%>/resources/images/icn_folderchek.png" width="20" height="16"  /><a id="asesoriasTerminada" onclick="cargaGridSolicitudesDeAsesoriaTerminadas();">Concluidas</a></span></li>
							</ul>			
						</li>
					</ul>
				</div>
			...
			<h3><a id="solicitudes" href="#" ><img src="<%=request.getContextPath() %>/resources/images/icn_carpprincipal.png" id="botpenal" width="15" height="15">&nbsp;Administraci&oacute;n</a></h3>
				<div >
