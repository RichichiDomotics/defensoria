...
<html>
    <head>
        ...
        <script type="text/javascript" 	src="<%=request.getContextPath()%>/js/solicitarAudienciaMich.js"></script>
		 	...
		 	function enviarSolicitudAudienciaProcu(){
		 	  ...
		 	  //eNABLE IT By Asdrubal FIN--Se agrega la lista de documentos seleccionados
		 	   ...
		 	   if(parametros.indexOf("tipoDeAudiencia=-1") > 0) {
		 	    ...
		 	    var tam = idsDoctsSelecc.length;
		 	    parametros += "&idsDoctsSelecc=" + idsDoctsSelecc;
		 	    if(tam == 0 || idsDoctsSelecc == undefined){
		 	    	...
		 	    	if( docExt=="1" ){
				 		if ($("#imputados").length==1 && $("#imputados")[0].length==0			
				 			...
				 			customConfirm("La solicitud generada se enviar&aacute; sin imputados ni v&iacute;ctimas asociadas.<br/>" +
				 					...
				 					function (){
				 						ejecutaAction("/enviarSolicitudAudienciaMich",function(respuesta) {
                ...
                <table cellspacing="5" border="0">
					...
					<tr>
						...
						<td width="169" style="vertical-align: top">						
							...
							<select id="distrito" class="parametro" style="width: 150%"></select>
						</td>
					</tr>
					<tr>
						...
						<td style="vertical-align: top">
							<input id="fechaEnvio" type="text" maxlength="100" class="parametro" style="width: 150%"/>
<!-- 							<span id="fechaEnvio"></span> -->
						</td>
					</tr>
					<tr>
						<td style="vertical-align: top">
						...
						<td style="vertical-align: top">
							<input id="fechaInicio" type="text" maxlength="100" class="parametro" style="width: 100%"/>
<!-- 							<span id="fechaInicio"></span> -->
						...
						<td style="vertical-align: top">
							<input id="nombreDelSolicitante" type="text" maxlength="100" class="parametro" style="width: 150%"/>
						</td>
						<td style="vertical-align: top">
							<input id="prioridad" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
<!-- 						<td style="vertical-align: top"> -->
<!-- 							Institución solicitante: -->
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="institucionSolicitante" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
<!-- 						<td style="vertical-align: top;"> -->
<!-- 							Mp: -->
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="cveFuncionario" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
<!-- 						<td style="vertical-align: top;"> -->
<!-- 							Unidad de Investigacion: -->
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="unidadInv" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
<!-- 						<td style="vertical-align: top;"> -->
<!-- 							Tipo Iniciacion: -->
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="tipoIni" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
...
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="promovente" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
<!-- 						<td style="vertical-align: top;"> -->
<!-- 							Materia: -->
<!-- 						</td> -->
						<td style="vertical-align: top">
							<input id="materia" type="text" maxlength="100" class="parametro" style="visibility: hidden"/>
						</td>
					</tr>
