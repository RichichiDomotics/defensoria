...
public class AudienciaDTO extends EventoDTO {
    ...
    //eNABLE IT: Se agregan propiedades Causa y CatAudiencia, requeridos para la notificacion de audiencia de siaj
    private CausaDTO causadto;
    private CatAudienciaDTO catAudienciadto;
	...
	public CausaDTO getCausadto() {
		return causadto;
	}
	public void setCausadto(CausaDTO causadto) {
		this.causadto = causadto;
	}
	public CatAudienciaDTO getCatAudienciadto() {
		return catAudienciadto;
	}
	public void setCatAudienciadto(CatAudienciaDTO catAudienciadto) {
		this.catAudienciadto = catAudienciadto;
	}	
