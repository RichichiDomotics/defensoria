...
public class SalaAudienciaDTO extends GenericDTO {
    ...
    //eNABLE IT: Se agregan propiedad Juzgado, ya que los id de siaj no corresponden a los de sigi
    private CatJuzgadoDTO catJuzgadoDTO;
	...
	public CatJuzgadoDTO getCatJuzgadoDTO() {
		return catJuzgadoDTO;
	}
	public void setCatJuzgadoDTO(CatJuzgadoDTO catJuzgadoDTO) {
		this.catJuzgadoDTO = catJuzgadoDTO;
	}
}
