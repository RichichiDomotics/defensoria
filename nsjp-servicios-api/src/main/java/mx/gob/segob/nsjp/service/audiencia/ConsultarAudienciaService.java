...
public interface ConsultarAudienciaService {
	...
	/**
	 * Solicita las audiencias programadas entre las fechas inico y fin de audiencia y funcionario duenio del expediente.
	 * @param audiencia
	 * @return
	 * @throws NSJPNegocioException
	 */
	List<AudienciaDTO> consultarAudienciasByFechasyFuncionario(
			AudienciaDTO audiencia, Long claveFuncionario) throws NSJPNegocioException;
}
