/**
* Nombre del Programa : RegistrarAvisoSinDetencionDeAreaExterna.java
* Autor                            : Emigdio
* Compania                    : Ultrasist
 ...
 *
 */
public interface RegistrarAvisoSinDetencionDeAreaExterna {
	 ...
	 */
	AvisoDesignacionWSDTO registrarAvisoSinDetencion(AvisoDesignacionWSDTO aviso,Long idAgencia, String claveAgencia,Long idFuncionarioSolicitante) throws NSJPNegocioException;
