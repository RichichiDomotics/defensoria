...
public interface AvisoDetencionService {
	 ...
	 * Enable JC
	 * @param idInvolucrado
	 * @return true si ya se solicito defensor para este involucrado, false en caso contrario.
	 */
	Boolean tieneInvolucradoAvisoDetencion(Long idInvolucrado);
	 ...
	 */
	Boolean tieneInvolucradoDenunciaGenerada(Long idInvolucrado)throws NSJPNegocioException;
